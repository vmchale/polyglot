...
all:
    atspkg clean ; atspkg build --pkg-args "./native.dhall" target/polyglot.deb ; rm -f .atspkg/config
...
bench:
    bench "poly ~/git-builds/rust" "loc -u ~/git-builds/rust" "tokei ~/git-builds/rust" "gocloc ~/git-builds/rust" "scc -c ~/git-builds/rust"
